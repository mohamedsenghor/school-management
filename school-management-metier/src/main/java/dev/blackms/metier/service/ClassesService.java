...
import dev.blackms.metier.dao.IClassesDao;
import dev.blackms.metier.dao.ClassesDao;
import dev.blackms.metier.dao.ISectorsDao;
import dev.blackms.metier.dao.SectorsDao;
...
import dev.blackms.metier.mapper.ClassesMapper;
...
public class ClassesService implements IClassesService {
    ...
    public boolean update(ClassesDto classDto) {
        ...
        // Vérifier qu'une autre classe avec le même nom n'existe pas déjà dans ce
        // secteur
