...
import dev.blackms.metier.dto.SectorsDto;
import dev.blackms.metier.service.ISectorsService;
import dev.blackms.metier.service.SectorsService;
...
@WebService(endpointInterface = "dev.blackms.soap.webservice.service.SectorsWebService", serviceName = "SectorsWebService", portName = "SectorsWebServicePort", targetNamespace = "http://blackms.dev/school-management")
